        ...
        */
            ...
            else
            {
                ...
                for (var columnid in g.editors[rowdata['__id']])
                {
                    ...
                    if (column.name)
                    {
                    	...
                    	//author sun
                    	//add DateEditor default value 
                    	if(newdata[column.name] == null && o.input.type == 'DateEditor'){
                    		var converted = Date.parse(o.editParm.value);  
                       	 	var myDate = new Date(converted);
                    		newdata[column.name] = myDate;
                    	}
                    }
        ...
        endEdit: function (rowParm)
        {
            ...
            else if (rowParm != undefined)
            {
                ...
                delete g.editors[rowdata['__id']];
                delete rowdata['_editing'];
                g.trigger('afterEdit', { record: bakdata, rowindex: rowdata['__index'] });
            }
            else
            {
                for (var rowid in g.editors)
