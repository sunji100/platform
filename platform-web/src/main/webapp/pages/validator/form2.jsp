	...
	<form name="form1" id="form1">
		<table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td" style="width:160px"><input name="txtName" type="text" id="txtName" ltype="text" group="基础信息" validate="{required:true,minlength:3,maxlength:10}" /></td>
                <td align="left"></td>
            </tr>
            ...
            <tr>
                ...
                <input name="ddlDepart" id="ddlDepart" ltype="select" validate="{required:true}"/>
                </td><td align="left"></td>
            </tr>
            <tr>
