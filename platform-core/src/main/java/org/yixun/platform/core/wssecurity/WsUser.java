...
@Entity
@Table(name="ws_user")
public class WsUser extends AbstractEntity {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 5756527921777631911L;
	...
	@ManyToMany
	@JoinTable(name="ws_role_user_auth",joinColumns={@JoinColumn(name="USER_ID")},inverseJoinColumns={@JoinColumn(name="ROLE_ID")})
	...
	private static List<WsUser> findByNamedQuery(String queryName,Object[] params){
		return getRepository().findByNamedQuery(queryName, params, WsUser.class);
	}
	
	public boolean isAccountExist(){
		return !findByNamedQuery("findUserByUserAccount", new Object[]{this.userAccount}).isEmpty();
	}
	...
	public String toString() {
		return "User [abolishDate=" + abolishDate + ", createDate=" + createDate + ", name=" + name + ", serialNumber=" + serialNumber + ", sortOrder=" + sortOrder + ", createOwner=" + createOwner
				+ ", isValid=" + isValid + ", lastLoginTime=" + lastLoginTime + ", lastModifyTime=" + lastModifyTime + ", userAccount=" + userAccount + ", userDesc=" + userDesc + ", userPassword="
				+ userPassword + "]";
	}
}
